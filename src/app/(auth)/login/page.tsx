    ...
    <div className="flex min-h-[100dvh] pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] dark:bg-zinc-950">
      ...
      <div className="flex w-full flex-col justify-center px-6 py-10 lg:w-1/2 lg:px-16 xl:px-24 dark:bg-zinc-950">
        <div className="mx-auto w-full max-w-[440px]">
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <button
                    ...
                    className="mt-2 text-xs font-semibold text-emerald-600 hover:text-emerald-700 disabled:opacity-50"
                  >
                ...
                {!useRecoveryCode ? (
                  <div>
                    ...
                    <button
                      ...
                      className="mt-2 text-xs text-[var(--brand-600)] hover:text-[var(--brand-700)] font-medium transition-colors"
                    >
                      {t("twoFAUseRecovery")}
                    </button>
                  </div>
          ...
          {/* Divider + OAuth + footer: hidden during 2FA step */}
          {!twoFAStep && (
            <>
              {/* Divider */}
              ...
              {/* Apple OAuth — only when configured (APPLE_* env set). */}
              {process.env.NEXT_PUBLIC_APPLE_SIGNIN_ENABLED === "1" && (
                <button
                  type="button"
                  onClick={() => signIn("apple", { callbackUrl })}
                  className="mt-3 flex h-12 w-full items-center justify-center gap-3 rounded-xl bg-black text-sm font-medium text-white shadow-sm transition-all hover:bg-zinc-900 hover:shadow-md active:scale-[0.98] dark:bg-white dark:text-black dark:hover:bg-zinc-200"
                >
                  <svg
                    viewBox="0 0 384 512"
                    className="h-5 w-5"
