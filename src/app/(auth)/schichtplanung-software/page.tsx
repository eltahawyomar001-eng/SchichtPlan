...
export const metadata: Metadata = {
  ...
  description:
    "Schichtplanung Software: Dienstplan online erstellen, Schichten automatisch planen, Schichttausch per Klick. 14 Tage testen. Ideal für Gastronomie, Sicherheitsdienste, Einzelhandel & Pflege.",
  keywords: [
    "Schichtplanung",
  ...
  openGraph: {
    title: "Schichtplanung Software – Dienstplan online erstellen | Shiftfy",
    description:
      "Dienstplan online erstellen mit automatischer Konflikterkennung. 14 Tage testen, DSGVO-konform.",
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 pt-16 pb-12 sm:pt-24 sm:pb-16">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-4 text-sm text-gray-400">
              14 Tage Testphase · Jederzeit kündbar · DSGVO-konform
            </p>
          </div>
        </div>
      </header>
