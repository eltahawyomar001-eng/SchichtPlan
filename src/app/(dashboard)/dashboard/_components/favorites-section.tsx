              ...
              return (
                <div key={key} className="relative group">
                  <Link
                    href={page.href}
                    className={cn(
                      "flex flex-col items-center justify-center gap-3 rounded-2xl bg-white dark:bg-zinc-900 p-5 sm:p-6 border border-gray-100 dark:border-emerald-500/30 ring-1 ring-gray-900/[0.04] dark:ring-emerald-500/30 transition-all duration-200",
