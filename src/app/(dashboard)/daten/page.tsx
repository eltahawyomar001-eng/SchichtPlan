          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
              <input
                readOnly
                value={icalUrl}
                className="flex-1 min-w-0 rounded-lg border border-gray-200 dark:border-zinc-700 bg-gray-50 dark:bg-zinc-800/50 px-3 py-2 text-sm font-mono text-gray-700 dark:text-zinc-300 truncate"
              />
              <button
                onClick={copyIcal}
