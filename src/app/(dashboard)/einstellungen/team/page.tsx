                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <div className="flex-1 space-y-1.5">
                    ...
                    <div className="relative">
                      <MailIcon className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-gray-400 dark:text-zinc-500 pointer-events-none" />
                      <Input
                        id="invite-email"
                        type="email"
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      member.role !== "OWNER" ? (
                        <select
                          ...
                          className={`rounded-full px-2.5 py-0.5 text-xs font-medium border-0 cursor-pointer focus:ring-2 focus:ring-emerald-500 ${roleBadgeColor[member.role] || roleBadgeColor.EMPLOYEE}`}
                        >
                          <option value="ADMIN">{t("roleAdmin")}</option>
                          <option value="MANAGER">{t("roleManager")}</option>
                          <option value="EMPLOYEE">{t("roleEmployee")}</option>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1">
                        <button
                          ...
                          className="rounded-lg p-1.5 text-gray-400 hover:text-emerald-600 hover:bg-emerald-50 transition-colors disabled:opacity-50"
                          title={t("resend")}
                        >
