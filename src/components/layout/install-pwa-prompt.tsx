      ...
      <>
        ...
        <div className="fixed inset-x-0 bottom-0 z-[70] rounded-t-2xl bg-white shadow-xl animate-slide-up">
          ...
          <div className="px-5 pb-6 pt-2">
            ...
            <button
              onClick={handleDismiss}
              className="mt-5 w-full rounded-xl bg-emerald-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-emerald-700 transition-colors"
            >
              {t("understood")}
            </button>
          </div>
    ...
    <div className="fixed bottom-4 inset-x-4 z-[60] sm:inset-x-auto sm:right-4 sm:left-auto sm:w-80 rounded-2xl border border-gray-200 bg-white shadow-xl p-4 animate-slide-up mb-[env(safe-area-inset-bottom)]">
      ...
      <div className="flex gap-2 mt-3">
        ...
        <button
          ...
          className="flex-1 flex items-center justify-center gap-1.5 rounded-xl bg-emerald-600 px-3 py-2 text-xs font-semibold text-white hover:bg-emerald-700 transition-colors"
        >
