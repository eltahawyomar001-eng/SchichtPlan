...
export function Topbar({ title, description, actions }: TopbarProps) {
  ...
  return (
    <header className="sticky top-0 z-30 flex items-center justify-between border-b border-gray-200 bg-white/80 backdrop-blur-sm px-4 sm:px-6 py-2.5 sm:py-3.5 gap-2 sm:gap-3 pt-[max(0.625rem,env(safe-area-inset-top))]">
